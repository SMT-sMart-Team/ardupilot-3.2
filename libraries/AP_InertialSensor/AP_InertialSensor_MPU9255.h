...
#ifndef __AP_INERTIAL_SENSOR_MPU9255_H__
#define __AP_INERTIAL_SENSOR_MPU9255_H__
...
#define MPU9255_DEBUG 0

class AP_InertialSensor_MPU9255 : public AP_InertialSensor_Backend
{
public:

    AP_InertialSensor_MPU9255(AP_InertialSensor &imu);
...
#endif // __AP_INERTIAL_SENSOR_MPU9255_H__
